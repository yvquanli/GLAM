...
class GLAM():
    ...
    def generate_config(self):
        config = {
            ...
            'pro_block': choice(['_NNConv', '_GCNConv', '_GATConv']),  # '_TripletMessage', '_TripletMessageLight',
        ...
        if config['optim'] == 'Adam':
            ...
            config['batch_size'] = choice([8, 16, 16, 16, 32, 32, 32, 64, 128, 256, 512])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='bindingdb_c', help='bindingdb_c, lit_esr1ant')
    parser.add_argument('--n_init_configs', default=30, type=int, help='n initialized configurations')
    parser.add_argument('--n_run_few_epoch', default=1, type=int, help='n run for few epochs')
